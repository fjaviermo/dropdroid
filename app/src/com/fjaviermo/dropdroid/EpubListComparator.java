 ...
 */
public class EpubListComparator implements Comparator<DbxFileInfo> {
     ...
     */
    public static EpubListComparator getNameFirst(boolean ascending) {
        return new EpubListComparator(true, ascending);
    }
     ...
     *  vs. descending (reversed).
     */
    public static EpubListComparator getDateFirst(boolean ascending) {
        return new EpubListComparator(false, ascending);
    }

    private EpubListComparator(boolean nameFirst, boolean ascending) {
